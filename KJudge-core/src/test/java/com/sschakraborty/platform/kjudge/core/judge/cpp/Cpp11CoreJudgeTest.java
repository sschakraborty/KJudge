...
public class Cpp11CoreJudgeTest {
	private final Properties masterProperties;
	private final Cpp11CoreJudge judge;

	public Cpp11CoreJudgeTest() throws AbstractBusinessException {
		PropertyFileReader propertyFileReader = new PropertyFileReader();
		this.masterProperties = propertyFileReader.readPropertiesUsingFileName("kjudge.properties");
		judge = new Cpp11CoreJudge();
	}
	...
	public void performJudgement() throws AbstractBusinessException {
		...
		User user = new User();
		user.setPrincipal("Cpp11TestUser");
